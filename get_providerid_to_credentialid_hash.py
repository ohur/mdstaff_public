...
def get_providerid_to_credentialid_hash(data_file = "/data/credential_id_table_sccin.f.txt"):
    ...
    logger.info(wkday + ". Getting ProviderID and CredentialID Mapping Table from " + data_file)
    ...
    with open(data_file, "r") as csvfile:
        ...
        for row in reader:
            provider_id = row[1]
            credential_id = row[0]
            id_hash[provider_id] = credential_id

    return(id_hash)


def main():
    id_hash = get_providerid_to_credentialid_hash()
